        ...
        private void ClearButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (MainWindow.AddonManager?.SelectedAddon != null)
            {
                if (MainWindow.AddonManager.SelectedAddon.IsMultipleDrawablesSelected)
                {
                    ...
                    Helpers.LogHelper.Log($"已清除 {selectedDrawables.Count} 个 Drawable 的分组", Views.LogType.Info);
                }
                else if (MainWindow.AddonManager.SelectedAddon.SelectedDrawable != null)
                {
                    ...
                    Helpers.LogHelper.Log($"已清除 Drawable '{MainWindow.AddonManager.SelectedAddon.SelectedDrawable.Name}' 的分组", Views.LogType.Info);
                }
