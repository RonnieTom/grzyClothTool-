...
namespace grzyClothTool.Views
{
    ...
    public partial class DrawableSelectWindow : Window, INotifyPropertyChanged
    {
        ...
        public List<string> AssetTypes { get; set; } = ["组件", "配饰"];
        ...
        public bool IsProp => SelectedAssetType == "配饰";
        ...
        private void AssetType_IsUpdated(object sender, Controls.UpdatedEventArgs e)
        {
            ...
            {
                "组件" or "Component" => EnumHelper.GetDrawableTypeList(),
                "配饰" or "Prop" => EnumHelper.GetPropTypeList(),
                _ => [],
            };
        }
