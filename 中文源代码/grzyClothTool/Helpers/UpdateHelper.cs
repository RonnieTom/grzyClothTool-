...
public static class UpdateHelper
{
    ...
    public async static Task CheckForUpdates()
    {
        ...
        if (args.Contains("--skipUpdate"))
        {
            ...
            {
                App.splashScreen.AddMessage("正在完成更新...");
        ...
        try
        {
            ...
            {
                App.splashScreen.AddMessage("无法检查更新。");
            ...
            {
                App.splashScreen.AddMessage("您已是最新版本！");
                await Task.Delay(500, cts.Token);
                return;
            }

            App.splashScreen.AddMessage($"正在下载 v{latestVersion}...");
            
            await DownloadUpdate(latestVersion, cts.Token);
        }
        catch (OperationCanceledException)
        {
            App.splashScreen.AddMessage("更新检查超时。");
            await Task.Delay(1000);
        }
        catch (Exception ex)
        {
            App.splashScreen.AddMessage("更新检查失败。");
            try
            {
    ...
    private static async Task DownloadUpdate(string version, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            App.splashScreen.AddMessage("下载完成，正在安装...");
        ...
        {
            App.splashScreen.AddMessage("下载已取消。");
        ...
        catch(Exception ex)
        {
            ...
            App.splashScreen.AddMessage("下载失败，请稍后重试。");
    ...
    private static void ExtractAndRunUpdatedApp()
    {
        ...
        catch (Exception ex)
        {
            ...
            App.splashScreen?.AddMessage("安装失败，请手动更新。");
